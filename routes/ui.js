...
router.get('/if_numbers', function(req, res, next) {
  res.render('frame_of_if_numbers',{"if_name":req.param("if_name"),"disp_name":req.param("disp_name")});
});
...
router.get('/if_arrows', function(req, res, next) {
  res.render('frame_of_if_arrows',{"if_name":req.param("if_name"),"disp_name":req.param("disp_name")});
});
router.get('/if_toggles', function(req, res, next) {
  res.render('frame_of_if_toggles',{"if_name":req.param("if_name"),"disp_name":req.param("disp_name")});
});
